...
Run with the -testnet option to run with "play zenacoins" on the test network, if you
...
Zenacoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ZenacoinMiner : Generates zenacoins (if wallet is enabled).
...
- src/libsecp256k1
  - Upstream at https://github.com/zenacoin-core/secp256k1/ ; actively maintaned by Core contributors.

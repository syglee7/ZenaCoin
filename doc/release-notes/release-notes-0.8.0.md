Zenacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/zenacoin/files/Zenacoin/zenacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Zenacoin
...
New/changed settings (command-line or zenacoin.conf file)
--------------------------------------------------------

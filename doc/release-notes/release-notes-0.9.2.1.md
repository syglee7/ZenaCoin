Zenacoin Core version 0.9.2.1 is now available from:

  https://zenacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ZNC to 0.01 ZNC
...
- Fix "Start zenacoin on system login"

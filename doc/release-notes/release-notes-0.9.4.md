Zenacoin Core version 0.9.4 is now available from:

  https://zenacoin.org/bin/0.9.4/
...
this update is incompatible with the Zenacoin system and could lead to consensus
forks.

Zenacoin Core released binaries from https://zenacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~zenacoin/+archive/ubuntu/zenacoin
- A third-party or self-compiled Zenacoin Core

upgrade to Zenacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

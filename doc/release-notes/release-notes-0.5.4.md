Zenacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/zenacoin/files/Zenacoin/zenacoin-0.5.4/
...
http://gitorious.org/zenacoin/zenacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Zenacoin-Qt notifications under Growl 1.3.
Increase required age of Zenacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZenacoin properly when installing Zenacoin-Qt over it. (Windows)

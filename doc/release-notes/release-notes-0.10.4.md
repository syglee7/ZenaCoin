Zenacoin Core version 0.10.4 is now available from:

  <https://zenacoin.org/bin/zenacoin-core-0.10.4/>
...
- #6953 `43c2789` Split zenacoin-tx into its own package
- #6953 `dfe0d4d` Include zenacoin-tx binary on Debian/Ubuntu

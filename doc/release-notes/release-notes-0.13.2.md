Zenacoin Core version 0.13.2 is now available from:

  <https://zenacoin.org/bin/zenacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update zenacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow zenacoin-tx to create v2 transactions (zncdrak)

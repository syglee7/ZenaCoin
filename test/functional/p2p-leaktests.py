...
Also test that nodes that send unsupported service bits to zenacoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if zenacoind ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
